...
public class AgendaDeConsultas {
    ...
    public DadosDetalhamentoConulta agendar (DadosAgendamentoConsulta dados){
        ...
        if (medico ==null){
            throw new ValidacaoException("Não exite medico disponivel nessa data");
        }
        var consulta = new Consulta(null,medico, paciente, dados.data(),null);
        consultaRepository.save(consulta);
        return new DadosDetalhamentoConulta(consulta);
    }
    ...
    public void cancelar(DadosCancelamentoConsulta dados) {
        if(!consultaRepository.existsById(dados.idConsulta())){
            throw new ValidacaoException("Id da consulta invalido");
        }
