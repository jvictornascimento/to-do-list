...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosDetalhamentoConulta> dadosDetalhamentoConultaJacksonTester;
    @MockBean
    ...
    void agendar_cenario2() throws Exception {
        ...
        var especialidade = Especialidade.CARDIAOLOGIA;
        var dadosdetalhamento = new DadosDetalhamentoConulta((Long) null, 2l, 5l, data);
        ...
        var jsonEsperado= dadosDetalhamentoConultaJacksonTester.write(
               dadosdetalhamento
        ).getJson();
